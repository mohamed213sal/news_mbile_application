...
class _FaceBookFeedState extends State<FaceBookFeed> {
      ...
      children: <Widget>[
        Expanded(
            child: Padding(
              ...
              child: Text(
                "some idioms and podiums up to speed , take something to conclusions   ",
                style: TextStyle(
                    fontSize: 15,
                    letterSpacing: 1.5,
                    height: 1.25,
  ...
  Widget _drawHashTags() {
    return Container(
      child: Wrap(
        children: <Widget>[
          FlatButton(
            onPressed: () {}, child: Text("#Advanced", style: _HashTagStyle,),),
          FlatButton(
            onPressed: () {}, child: Text("#Advanced", style: _HashTagStyle,),)
        ],
      ),
  ...
  Widget _CardFooter() {
    return Row(
      ...
      children: <Widget>[
        FlatButton(
            child: Text("commits", style: TextStyle(color: Colors.orange),),
            onPressed: () {}),
        FlatButton(child: Text("SHARE", style: TextStyle(color: Colors.orange)),
            onPressed: () {}),
        FlatButton(child: Text("OPEN", style: TextStyle(color: Colors.orange)),
            onPressed: () {}),
      ],
    );
  }
